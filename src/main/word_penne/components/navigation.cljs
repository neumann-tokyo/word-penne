  ...
  [:nav (use-style s-navigation)
   ...
   [:div#navigation-menu (use-style s-opened-navigation)
    ...
    [:a (use-style s-nav-link {:href "#"
     ...
     [:span (use-style s-nav-link-text) (.gettext (i18n) "Cards")]]
    (doall (map-indexed
            (fn [index tag]
    ...
    [:a (use-style s-nav-link {:href (path-for routes :word-penne.pages.tags/index)})
     ...
     [:span (use-style s-nav-link-text) (.gettext (i18n) "Edit tags")]]
    [:a (use-style s-nav-link {:href "#"
     ...
     [:span (use-style s-nav-link-text) (.gettext (i18n) "Archive")]]]])
